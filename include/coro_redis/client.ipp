...
namespace impl {
	...
	public:
		awaiter_t connect(event_base* base, std::string_view host_sv, uint16_t port, long timeout_seconds) {
		...
		//bool create_conn_pool(const std::vector<event_base*> contexts, std::string_view host_sv, uint16_t port, long timeout_seconds) {
		//	return true;
		//}
	};
